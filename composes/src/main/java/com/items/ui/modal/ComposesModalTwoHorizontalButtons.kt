...
@Composable
fun ComposesModalTwoHorizontalButtons(
...
@Composable
internal fun PreviewModalTwoHorizontalButtonsLight() {
    UicomposablesTheme {
        Surface {
...
@Preview(showBackground = true)
@Composable
internal fun PreviewModalTwoHorizontalButtonsDark() {
