...
fun ComposesPasswordInput(
    ...
    Column(
        ...
        OutlinedTextField(
            ...
            placeholder = {
                ComposesText18(
                    text = stringResource(id = R.string.placeholder_your_must_enter_password)
                )
            },
            supportingText = {
                ComposesText16(
...
@Composable
internal fun PreviewPassInputLight() {
...
@Preview(showBackground = true)
@Composable
internal fun PreviewPassInputDark() {
    val passValue = remember { mutableStateOf("") }
    val errorInput = false
    val errorMessage = ""
